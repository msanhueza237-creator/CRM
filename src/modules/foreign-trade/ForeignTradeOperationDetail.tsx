...
function allocationLabel(value: ForeignTradeCostLine["allocation_method"]) { return ({ operation: "Sin distribuir", fob_value: "Por FOB", units: "Por unidades", weight: "Por peso", cbm: "Por CBM", manual: "Manual", combined: "Combinado" })[value]; }
