...
const payables = renderToStaticMarkup(React.createElement(components.PayablesView, props));
assert.match(payables, /Actualizar por cobrar y por pagar desde Excel Facto/);
assert.match(payables, /aria-controls="payables-excel"/);
assert.match(payables, /Sin respaldo Excel de proveedores confirmado/);
