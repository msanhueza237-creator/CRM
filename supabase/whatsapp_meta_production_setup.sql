...
begin
  if exists (
    ...
    set business_account_id = '2282055142597894',
        ...
        active = true,
        last_connection_status = 'numero_registrado_webhook_validado',
    ...
    values (
      ...
      '+56940951484',
      true,
      'numero_registrado_webhook_validado',
      now(),
      null
    );
  end if;
...
-- Permite que el CRM encuentre rapido la conversacion por numero.
