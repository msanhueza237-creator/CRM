...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!(["message", "campaign-draft", "report", "legacy-message", "voice-session", "voice-result", "voice-interrupt", "voice-end", "voice-usage"].includes(route) && req.method === "POST") && !(["conversations", "history", "export", "inventory", "voice-stats"].includes(route) && req.method === "GET")) {
    ...
    if (["message", "conversations", "history", "export", "inventory", "voice-session", "voice-result", "voice-interrupt", "voice-end", "voice-usage", "voice-stats"].includes(route)) {
